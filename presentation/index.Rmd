...
- We found that we shared an idea of writing an R-spatial book
...
Publishers allowing for a hybrid model books: CRC Press, O'Reilly, OTexts, Princeton, Cambridge University Press
...
.pull-right[
- A few months into making the book, Robin and I were contacted by<!-- a person we never met before,--> a postdoc at Friedrich-Schiller-University Jena and an author of the RQGIS package
...
.pull-right[
**Exisiting packages authors' feedback**:
...
.footnote[
**Slides:** http://bit.ly/geocompr-slides
]
